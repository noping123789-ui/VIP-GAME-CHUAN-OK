...
export enum CameraMode {
  // === 15 GÓC QUAY TRUYỀN HÌNH THỰC TẾ (BROADCAST TV) ===
  ...
  VERTICAL_PORTRAIT_OPTIMIZED = 'VERTICAL_PORTRAIT_OPTIMIZED', // 8. Khung hình dọc 9:16 truyền hình
  SPECTATOR_TRACKSIDE = 'SPECTATOR_TRACKSIDE', // 9. Góc quay người đứng ven đường (Tuyệt đối đứng yên, chỉ lia theo xe)
  HELIPAD_ZOOM = 'HELIPAD_ZOOM', // 10. Trực thăng treo tĩnh thu phóng từ xa
  SATELLITE_ORBIT = 'SATELLITE_ORBIT', // 11. Vệ tinh vũ đạo từ không gian
  TUNNEL_CEILING_FAST = 'TUNNEL_CEILING_FAST', // 12. Camera trần hầm hắt xuống siêu tốc
  FENDER_WHEEL_LOOK = 'FENDER_WHEEL_LOOK', // 13. Camera chắn bùn nhìn lốp và hông xe
  WING_REAR_LOOK = 'WING_REAR_LOOK', // 14. Đuôi gió nhìn ngược về trước qua nóc xe
  KERB_CAM_GROUND = 'KERB_CAM_GROUND', // 15. Camera âm vỉa gờ giảm tốc hất lên gầm xe

  // === 12 GÓC QUAY CINEMATIC KINH ĐIỂN (CLASSIC CAMERAS) ===
  ...
  COCKPIT_FIRST_PERSON = 'COCKPIT_FIRST_PERSON', // 11. Góc Lái Thứ Nhất (Trực tiếp trong cabin lái, tốc độ cực cao)
  BUMPER_FIRST_PERSON = 'BUMPER_FIRST_PERSON', // 12. Góc Cản Trước Siêu Tốc (Gần sát đường, FOV 100 độ xé gió)
}
